...
# Copyright (C) 2017 Fredrik Atmer
#
...
"""Keyboard definition for MasterKeys S keyboard"""

import easykeymap.templates.ATmega32U2_16MHz_COSTAR as firmware
from easykeymap.ioports import *

description = "Masterkeys S (Unloved Bastard)"
unique_id = "MASTERKEYSS_001"
cfg_name = "costar87"
...
#     REF_PORTB    REF_PORTC    REF_PORTD
    ...
    ( 0b00000000 , 0b00000000 , 0b00010111 ),
    ( 0b00000000 , 0b00000000 , 0b00110011 ),
    ( 0b00000000 , 0b00000000 , 0b00010011 ),
    ( 0b00000000 , 0b00000000 , 0b00011011 ),
    ( 0b00000000 , 0b00000000 , 0b00110100 ),
    ( 0b00000000 , 0b00000000 , 0b00111010 ),
    ...
    ( 0b00000000 , 0b00000000 , 0b00100111 ),
